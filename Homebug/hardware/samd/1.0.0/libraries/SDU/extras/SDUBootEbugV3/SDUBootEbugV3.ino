...
#define SDU_START    0x2000 // UF2 bootloader: The bootloader sits at 0x00000000, and the application starts at 0x00002000 (SAMD21) or 0x00004000 (SAMD51).
#define SDU_SIZE     0x4000 // 16,368 bytes < 0x4000 = 16384 bytes

#define SKETCH_START (uint32_t*)(SDU_START + SDU_SIZE)

#ifndef SDCARD_SS_PIN
#define SDCARD_SS_PIN 25
#endif
