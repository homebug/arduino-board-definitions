...
# Or use
# /opt/arduino-1.8.9/arduino --verify --board "homebug:samd:ebug3_0" --preserve-temp-files --pref build.path="/home/jpmeijers/Homebug/Arduino Board Definitions/Homebug/hardware/samd/1.8.3/libraries/SDU/extras/SDUBootEbugV3" SDUBootEbugV3.ino
